 ...
 */
public class XfermodeView2 extends ImageView {
    ...
    public XfermodeView2(Context context, AttributeSet attrs, int defStyle) {
...
//        int cnt = canvas.saveLayer(0, 0, getWidth(), getHeight(), null, Canvas.ALL_SAVE_FLAG);
        ...
        Paint showContentPaint = new Paint();
        showContentPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
        canvas.drawBitmap(bitcircle, 0, 0, showContentPaint);
