...
//        }
    ...
    public AnimatorSet startAnimation() {
        hideView();
        //布局飞入
        ObjectAnimator flyFromLtoR = GiftAnimationUtil.createFlyFromLtoL(anim_rl, getWidth(), 0, 400, new OvershootInterpolator());
        flyFromLtoR.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                ...
                isShowing = true;
                isEnd = false;
                anim_header.setImageResource(R.drawable.demo_lulu02);
/*
...
/*        if (!mGift.getGiftPic().equals("")){
            anim_gift.setImageResource(R.drawable.ic_launcher);
...
//        ObjectAnimator flyFromLtoR2 = GiftAnimationUtil.createFlyFromLtoR(anim_gift, -getWidth(), 0, 400, new DecelerateInterpolator());
        ObjectAnimator flyFromLtoR2 = GiftAnimationUtil.createFlyFromLtoL(anim_gift, getWidth(), 0, 400, new DecelerateInterpolator());
